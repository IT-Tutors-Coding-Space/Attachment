...
<body class="bg-gray-100 d-flex flex-column min-vh-100">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-lg p-3">
        <div class="container-fluid d-flex justify-content-between">
            <h2 class="text-white fw-bold fs-3">🔧 AttachME - Admin Sign Up</h2>
    ...
    <div class="container p-5 flex-grow-1 d-flex justify-content-center align-items-center">
        <div class="card border-0 shadow-sm p-4 bg-white rounded-lg w-100" style="max-width: 500px;">
            ...
            <!-- Admin Signup -->
            <form id="adminSignupForm" class="signup-form" action="../SignUps/AdminRegs.php" method="POST">
                <h6 style="text-align: center;" class="fw-bold text-secondary">🔧 Admin Registration</h6>
                <div class="mb-3">
                    <label for="adminName" class="form-label">Full Name</label>
                    <div class="input-group">
                        <span class="input-group-text"><i class="fa fa-user"></i></span>
                        <input name="full_name" type="text" class="form-control" id="adminName" placeholder="Enter full name" required>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input name="email" type="email" class="form-control" id="adminEmail" pattern="^[a-zA-Z0-9._%+-]+@attachme\.admin$" placeholder="username@attachme.admin" required>
                    </div>
                </div>
                <div class="mb-3">
                    <label for="adminRole" class="form-label">Admin Role</label>
                    <select name="role" class="form-control" id="adminRole" required>
            ...
            <p class="text-center mt-3">Already have an account? <a href="Loginn.php" class="text-primary fw-bold">Log In</a></p>
        </div>
    </div>
